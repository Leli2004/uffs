...
- getDate (retorna o dia ou o mês ou o ano de uma data passada como parâmetro. O tipo de retorno deve ser passado como parâmetro também)
- showDate (mostra a data em um formato amigável para o usuário)
- dataComp (recebe duas datas como parâmetro é retorna 1 se a primeira data é maior que a segunda, -1 caso contrário e 0 se forem iguais)
- getDiff (recebe duas datas como parâmetro é retorna a diferença absoluta de dias entre elas. Como absoluto é: retornar sempre valores positivos)
